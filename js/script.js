...
mobile_gradient_div = `
    <img class="top_logo" src="img/RaspiMote_logo_500px.png"/>
    <h1>RaspiMote</h1>
    <p>
    ...
    <table>
        <tbody>
            <td onmouseover="makeWhite(this)" onmouseout="makeTransparent(this)" id="docs">
                <a href="https://docs.raspimote.tk/">
                    <div class="full_td">
                        <img class="icon" src="img/docs.png"/>
                        &nbsp;Read the docs
                    </div>
                </a>
            </td>
    ...
    <table>
        <tbody>
            <td onmouseover="makeWhite(this)" onmouseout="makeTransparent(this)" id="github">
                <a href="https://github.com/RaspiMote/RaspiMote">
                    <div class="full_td">
...
function init() {
    ...
    if (on_mobile()) {
        ...
        root.style.setProperty("--overflowY", "scroll");
        root.style.setProperty("--topLogoWidth", "20vw");
        root.style.setProperty("--h1FontSize", "15vw")
        root.style.setProperty("--tableWidth", "80vw")
        root.style.setProperty("tdBorderRadius", "5vw")
        root.style.setProperty("--iconHeight", "6vw")
        root.style.setProperty("--pFontSize", "6vw")
        root.style.setProperty("--pMaxWidth", "80vw")
        root.style.setProperty("--footerFontSize", "1.2vw")
        root.style.setProperty("--ftdFontSize", "7vw")
        document.getElementById("gradient").innerHTML = mobile_gradient_div;
    }
    $(".fade").fadeOut(1500);
}
